  ...
  return (
    <div>
      ...
      <div style={{ padding: 10 }} className="">
        <PoseButton switchGoodPose={switchGoodPose} data={tree} poseName="Tree Pose" image={treePose} />
        <PoseButton switchGoodPose={switchGoodPose} data={warrior} poseName="Warrior Pose" image={warriorPose} />
      </div>
    </div>
  );
};
